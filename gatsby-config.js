...
module.exports = {
  siteMetadata: {
    title: "GraphCMS Blog",
    description: "Gatsby blog starter for GraphCMS! Powered by `gatsby-source-graphcms`, featuring `gatsby-image` and MDX!",
  ...
  plugins: [
    ...
    // "gatsby-plugin-postcss",
    {
      ...
      options: {
        ...
        endpoint: `https://api-ap-south-1.graphcms.com/v2/cl4f79jee1dpe01wbbaxohsha/master`,
